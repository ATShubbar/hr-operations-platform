...
| [ADR-003](ADR-003-module-structure-and-boundaries.md) | Module structure and boundary enforcement | Proposed |
...
| [ADR-006](ADR-006-ksa-cloud-provider.md) | KSA cloud provider selection | Open |
