...
| [ADR-006](ADR-006-ksa-cloud-provider.md) | KSA cloud provider selection | **Accepted rev. 5, pending provisioning-day verification** (OCI — Riyadh home region, Jeddah second; OKE runtime; migratability per ADR-010) |
